...
export const Login: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col items-center justify-center p-6 bg-[#0f0f10] overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-sm space-y-10">
        <div className="text-center space-y-4">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-3xl bg-[#1c1c1e] border border-white/5 shadow-xl">
        ...
        <div className="bg-[#1c1c1e] p-1.5 rounded-3xl border border-white/5 flex relative">
          <div 
            className={cn(
              "absolute top-1.5 bottom-1.5 w-[calc(50%-6px)] bg-orange-500 rounded-2xl shadow-lg transition-all duration-300 ease-out",
        ...
        <form className="space-y-6" onSubmit={handleLogin}>
          <div className="space-y-4">
            <Input 
              ...
              className="bg-[#1c1c1e] border-white/5 text-white"
            />
            <Input 
              label="Senha"
              placeholder="••••••••"
          ...
          <Button 
            ...
            className="bg-orange-500 hover:bg-orange-600 text-white font-bold h-14 rounded-2xl"
          >
        ...
        <div className="space-y-6">
          ...
          <div className="flex justify-center">
            <Button 
              variant="secondary" 
              fullWidth 
              className="gap-3 h-14 rounded-2xl border border-white/5 bg-[#1c1c1e] hover:bg-[#2c2c2e] transition-all"
